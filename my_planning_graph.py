...
class PlanningGraph():
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (set(action1.effect_add) & set(action2.precond_neg)  |
                set(action1.effect_rem) & set(action2.precond_pos)  |
                set(action2.effect_add) & set(action1.precond_neg)  |
                set(action2.effect_rem) & set(action1.precond_pos) )
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return (set(node_a1.action.precond_pos) & set(node_a2.action.precond_neg) | 
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        if node_s1.symbol == node_s2.symbol:
            return not node_s1.__eq__(node_s2)
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in self.problem.goal:
            nodeGoal = PgNode_s(goal, True)
            for level, nodes in enumerate(self.s_levels):
                if nodeGoal in nodes:
                    level_sum += level
                    break
